...
async function main() {
  ...
  const contract = new ethers.Contract(addressC, abi, provider);
  ...
  contract.on("Transfer", (from, to, value) => {
    ...
    connection.connect();
    var addSql =
      "INSERT INTO transfer(id,addressFrom,addressTo,value) VALUES(0,?,?,?)";
    var addSqlParams = [String(from), String(to), String(value)];
